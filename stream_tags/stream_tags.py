...
import sip
import stream_tags_epy_block_0 as epy_block_0  # embedded python block
import threading



class stream_tags(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "stream_tags", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("stream_tags")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "stream_tags")
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_repeat_0, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
...
def main(top_block_cls=stream_tags, options=None):
