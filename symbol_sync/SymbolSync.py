...
class SymbolSync(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SymbolSync", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SymbolSync")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "SymbolSync")
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_win, 8, 0, 1, 1)
        for r in range(8, 9):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc((2*math.pi/100), constellation.arity(), False)
        ...
        self.connect((self.analog_agc_xx_1, 0), (self.qtgui_freq_sink_x_0_0, 1))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_freq_sink_x_0_0, 3))
...
def main(top_block_cls=SymbolSync, options=None):
