...
class measure_ISM_band(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "measure_ISM_band", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("measure_ISM_band")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "measure_ISM_band")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.centre_freq, self.samp_rate)
...
def main(top_block_cls=measure_ISM_band, options=None):
