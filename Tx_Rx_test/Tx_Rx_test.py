...
class Tx_Rx_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx_Rx_test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx_Rx_test")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Tx_Rx_test")
...
def main(top_block_cls=Tx_Rx_test, options=None):
