...
class ieee802154_packet_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_offset = freq_offset = int(-2.5e6)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/diego/Documents/SDR_projects/capture_nRF/data/802154_802154_2425MHz_2430MHz.dat', True, 0, 0)
