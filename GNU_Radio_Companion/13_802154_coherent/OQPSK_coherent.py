...
class OQPSK_coherent(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._offset_range = qtgui.Range(-500e3, 500e3, 1e3, -20000, 200)
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, (samp_rate/40), True, 0 if "auto" == "auto" else max( int(float(0.1) * (samp_rate/40)) if "auto" == "time" else int(0.1), 1) )
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle2_0.set_sample_rate((self.samp_rate/40))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.tuning_LPF_cutoff_kHz*1000), (self.samp_rate/100), window.WIN_HAMMING, 6.76))
        self.qtgui_eye_sink_x_0_0_0_0.set_samp_rate(self.samp_rate/self.sps)
        self.qtgui_time_sink_x_0_0_0_0_0_0_0.set_samp_rate(self.samp_rate/self.sps)
